...
void JP::algorithmSolver(Graph & graph){
    ...
    std::vector<int> assigned_vertices[num_vertices];
...
std::set< std::set<int>> JP::find_and_color_MIS(int from, int to, std::vector<int> assigned_vertices, Graph &graph){
